...
const CHINESE_PARAMS = {
  'baoyu-comic': {
    ...
    // 子表格：画风
    'Style': '画风说明',
    'ligne-claire': '清线（欧洲漫画传统，均匀线条，扁平色彩）',
    'manga': '日漫（大眼，表情丰富，日式漫画风格）',
    'realistic': '写实（数字绘画，逼真比例，精细细节）',
    'ink-brush': '水墨（国风水墨，笔触韵味）',
    'chalk': '粉笔（黑板美学，手绘质感）',
    // 子表格：基调
    'Tone': '基调说明',
    'neutral': '中性（平衡理性，教育性强）',
    'warm': '温馨（怀旧感，私人化，舒适）',
    'dramatic': '戏剧（高对比，强视觉冲击力）',
    'romantic': '浪漫（柔美，装饰性强）',
    'energetic': '活力（明亮，动感）',
    'vintage': '复古（历史感，年代真实感）',
    'action': '动作（速度线，战斗效果）',
    // 子表格：预设
    'Preset': '预设快捷说明',
    '--style ohmsha': '小学社预设（日漫+中性，视觉隐喻，无对话头）',
    '--style wuxia': '武侠预设（水墨+动作，侠客战斗氛围）',
    '--style shoujo': '少女漫预设（日漫+浪漫，装饰元素，眼睛细节）',
    // 兼容性矩阵表头
    'Art Style': '画风',
    'ligne-claire': '清线',
    'manga': '日漫',
